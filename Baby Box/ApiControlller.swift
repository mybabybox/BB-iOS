...
class ApiControlller {
    ...
    func postComment(id: String, comment: String){
        print("In api call for id \(id) and comment --\(comment)")
        var strData = [String]()
...
//        var requestVm: CommentVM = CommentVM()
//        requestVm.postId = 48
//        requestVm.body = "this is test comment"
//        let argPayLoad = ApiControlller.toJson(requestVm)
