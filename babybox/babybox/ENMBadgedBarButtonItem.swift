...
let kENMDefaultPadding: CGFloat = 0.0
let kENMDefaultMinSize: CGFloat = 5.0
...
class ENMBadgedBarButtonItem: UIBarButtonItem {
    ...
    var badgeBackgroundColor: UIColor = UIColor.whiteColor() {
        didSet {
    ...
    var badgeFont: UIFont = UIFont.systemFontOfSize(10.0){
        didSet {
            refreshBadgeLabelProperties()
        }
    }
