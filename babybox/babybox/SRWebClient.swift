...
//  BabyBox
//
//  Created by Anshul Gupta on 1/12/16.
...
public class SRWebClient : NSObject
{
    ...
    *  @return self instance to support function chaining
    */
    public func data(imageCollections:[AnyObject], fieldName:String, data:RequestData?) -> SRWebClient {
        ...
        for image in imageCollections{
            let imageData: NSData = NSData(data: UIImageJPEGRepresentation(image as! UIImage, 1.0)!)
            postData += "--\(boundary)\r\n"
