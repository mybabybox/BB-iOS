        ...
        didSet {
            if isChecked != oldValue {
                ...
                if isChecked {
                    ...
                    let setViewController = mainStoryboard.instantiateViewControllerWithIdentifier("WelcomeID") as! SecondViewController
                    print(setViewController)
                    
                    //let rootViewController = self.window!.rootViewController
                    setViewController.navigationController?.pushViewController(setViewController, animated: true)
